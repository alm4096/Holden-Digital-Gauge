#ifndef GAUGELINECLASSH
#define GAUGELINECLASSH
#include "GaugeDrawClass.h"

class LineGauge : public GaugeDraw {
private:
  ...
  void DrawLineGauge(int l_x,int l_y, double l_number, int l_decimalPlaces);
 ...
 */
  void Setup(int l_height, int l_width, int l_boxshiftx, int l_boxshifty, uint16_t l_colour, uint16_t l_colour2, double l_ScaleLow, double l_ScaleHigh, int l_dp, String l_Name1, String l_Unit1, bool l_average, double l_period, bool l_drawNumber, bool l_drawBarGraph);
  void Setup(uint16_t l_colour, double l_ScaleLow, double l_ScaleHigh, int l_dp, String l_Name1, String l_Unit1, bool l_average, double l_period, bool l_drawNumber, bool l_drawBarGraph);
